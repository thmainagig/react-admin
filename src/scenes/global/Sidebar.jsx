...
const Item = ({title, to, icon, selected, setSelected})=>{
    ...
    return(
        ...
        style={{colors: colors.grey[100]}} onClick={()=> setSelected(title)} icon={icon}>
            ...
            {/* Logo and Menu item */}
                ...
                {!isCollapsed && (
                    <Box mb="25px">
                        ...
                        <img alt="profile-user" src={`../../assets/1.png`}
                         width="100px" height="100px" style={{cursor: "pointer", borderRadius:"50%"}} />
                        </Box>

                        <Box textAlign="center">
                            <Typography variant="h2" colors={colors.grey[100]} fontWeight="bold" sx={{m: "10px 0 0 0"}}>Ben maina</Typography>
                            <Typography variant="h5" colors={colors.greenAccent[500]} >Gravma Admin</Typography>
                        </Box>
                    </Box>
                )}
                ...
                <Typography variant="h6" color={colors.grey[300]} sx={{m: "15px 5px 0 20px"}}>Data</Typography>
                ...
                <Typography variant="h6" color={colors.grey[300]} sx={{m: "15px 5px 0 20px"}}>Pages</Typography>
                <Item title="Profile Form" to="/person" icon={<PersonOutlinedIcon />} selected={selected} setSelected={setSelected} />
                ...
                <Typography variant="h6" color={colors.grey[300]} sx={{m: "15px 5px 0 20px"}}>Charts </Typography>
